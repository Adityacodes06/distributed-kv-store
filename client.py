...
Usage:
  python client.py put <key> <value>   — Store a key-value pair
  python client.py get <key>           — Retrieve a value by key
  python client.py delete <key>        — Delete a key
  python client.py health              — Check node health
  python client.py metrics             — View node metrics
  python client.py cluster             — View cluster status

By default, the client connects to http://localhost:8001 (the leader).
Override with the --url flag:
